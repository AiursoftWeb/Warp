...
```bash
dotnet ef migrations remove --context "SqliteContext" -s ../Aiursoft.Warp/Aiursoft.Warp.csproj
```

## After Creating Migrations

After creating migrations for SQLite, remember to:
1. Create the corresponding migration for MySQL (see `../Aiursoft.Warp.MySql/HOW_TO_ADD_MIGRATIONS.md`)
