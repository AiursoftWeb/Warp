...
2. Create a new migration with a descriptive name:
   ...
   dotnet ef migrations add YourMigrationName \
     ...
     -s ../Aiursoft.Warp/Aiursoft.Warp.csproj
   ```
...
```bash
dotnet ef migrations remove --context "MySqlContext" -s ../Aiursoft.Warp/Aiursoft.Warp.csproj
```

## After Creating Migrations

After creating migrations for MySQL, remember to:
1. Create the corresponding migration for SQLite (see `../Aiursoft.Warp.Sqlite/HOW_TO_ADD_MIGRATIONS.md`)
