namespace Aiursoft.Warp.Authorization;
...
public class AppPermissions
{
    ...
    public static List<PermissionDescriptor> GetAllPermissions()
    {
        ...
        [
            ...
            new(AppPermissionNames.CanViewApiKey,
                localizer["View API Key"],
                localizer["Allows viewing the global API key and documentation for how to use it."]),
